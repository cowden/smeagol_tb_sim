...
/***************************************
* C S Cowden
* A Big Tungsten Block simulation.
* The purpose of this program is to simulate
* and study shower profiles in a large
* solid absorber block.
***************************************/
...
int main(int argc, char **argv) {
  ...
  auto actionInitialization = new WBActionInitialization(detConstruction);
